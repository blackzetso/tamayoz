...
<div class="app-content">
    <section class="section">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="/admin/1/about"> إعدادات الحساب </a></li>
        </ol>
                            ...
                            <div class="row text-right" dir="rtl" >
                                <div class="col-12 col-sm-12 col-md-4">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#profile4" role="tab" aria-controls="profile" aria-selected="false"> كلمة المرور </a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content border p-3" id="myTab3Content">
                                        <div class="tab-pane fade show active p-0" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                            <form id="editForm"  method="POST" class="form-horizontal" enctype="multipart/form-data" >
                                                ...
                                                <div class="form-group text-right row" dir="rtl" >
                                                    <label class="col-md-2 col-form-label" for="example-email"> البريد الإلكترونى </label>
                                                    <div class="col-md-10">
                                        ...
                                        <div class="tab-pane fade p-0" id="profile4" role="tabpanel" aria-labelledby="profile-tab4">
                                            <form id="editPass"  method="POST" class="form-horizontal" enctype="multipart/form-data" >
                                                @method('PUT')
                                                @csrf
                                                <div class="form-group text-right row" dir="rtl" >
                                        ...
                                        <div class="tab-pane fade p-0" id="contact4" role="tabpanel" aria-labelledby="contact-tab4">
                                            <div class="row mb-3" dir="rtl" >
                                                ...
                                                <div class="col-4" >
                                                    <img src="{{ asset('front/images/face') }}/@php if($user->img == null){ echo '1.jpg'; }else{ echo $user->img; } @endphp" style="width: 100%;border-radius:50%" >
                                                </div>
                                            </div>
