    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3"> إضافه شريحه جديده </h5>
            ...
            <form id="addForm" class="form-horizontal" enctype="multipart/form-data" >
                <div class="modal-body text-right">
                        ...
                        <div class="form-group row" dir="rtl" >
                            <label class="col-md-3 col-form-label"> اسم الزر </label>
                            <div class="col-md-9">
                                <input type="text" name="button" class="form-control" >
                            </div>
                        </div>
                        <div class="form-group row" dir="rtl" >
                            <label class="col-md-3 col-form-label"> رابط الزر </label>
                            <div class="col-md-9">
