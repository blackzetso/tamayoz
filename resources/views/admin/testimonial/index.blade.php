    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3"> إضافه رأى جديد </h5>
            ...
            <form id="addForm" class="form-horizontal" enctype="multipart/form-data" >
                <div class="modal-body text-right">
                        ...
                        <div class="form-group row" dir="rtl" >
                            <label class="col-md-3 col-form-label"> المحتوى </label>
                            <div class="col-md-9">
                                <textarea type="text" name="content" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group row" dir="rtl" >
                            <label class="col-md-3 col-form-label"> بواسطة </label>
                            <div class="col-md-9">
                                <input type="text" name="via" class="form-control" placeholder="مثال : فيسبوك" >
                            </div>
                        </div>
                        <div class="form-group row" dir="rtl" >
