    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3"> إضافه عضو جديد </h5>
            ...
            <form id="addForm" class="form-horizontal" enctype="multipart/form-data" >
                <div class="modal-body text-right">
                        ...
                        <div class="form-group row" dir="rtl" >
                            <label class="col-md-3 col-form-label"> المسمى الوظيفى </label>
                            <div class="col-md-9">
                                <input type="text" name="job" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row" dir="rtl" >
                            <label class="col-md-3 col-form-label"> نبذه </label>
                            <div class="col-md-9">
