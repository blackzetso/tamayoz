...
<div class="app-content">
    <section class="section">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/team"> فريق العمل </a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3" dir="rtl" >
                                ...
                                <div class="col-4" >
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#imageModal" >
                                        <img src="{{ asset('front/images/team') }}/{{ $team->img }}" style="width: 100%" >
                                    </a>
                                </div>
                            </div>
                            <form id="editForm"  method="POST" class="form-horizontal" enctype="multipart/form-data" >
                                ...
                                <div class="form-group text-right row" dir="rtl" >
                                    <label class="col-md-2 col-form-label" for="example-email"> الوظيفة </label>
                                    <div class="col-md-10">
                                        <input type="text" name="job" class="form-control" value="{{ $team->job }}">
                                    </div>
                                </div>
                                <div class="form-group text-right row" dir="rtl" >
                                    <label class="col-md-2 col-form-label"> نبذة </label>
                                    <div class="col-md-10">
                                        <textarea name="caption" class="form-control" >{{ $team->caption }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group text-right row" dir="rtl" >
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control" name="lang" required>
                                            ...
                                            <option @php if($team->lang == '1'){ echo "selected"; } @endphp value="1" >عربى</option>
                                            <option @php if($team->lang == '2'){ echo "selected"; }@endphp value="2" >English</option>
                                        </select>
                                    </div>
                                </div>
