...
<div class="app-content">
    <section class="section">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> قائمة الأقسام </li>
        </ol>
        ...
        <div class="modal-content">
            <form id="delForm">
                ...
                <div class="modal-body text-right">
                    سيؤدى حذف القسم إلي حذف جميع الخدمات والأعمال التي بداخله 
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3"> إضافه قسم جديد </h5>
